    ...
    examples = [
      {
        ...
        :file_content => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_ID_TOKEN),
      ...
      },
      {
        ...
        :file_content => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_JWT),
        :expect_token => EXECUTABLE_OIDC_TOKEN
      },
      {
        :name => "smal token",
        ...
        :file_content => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_SAML_RESPONSE),
  ...
  describe "test retrieve subject token executable works but response error" do
    examples = [
      ...
      },
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate({:version => 1}),
          :stderr => "",
          :exit_status => 0
        },
      ...
      },
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate({:version => 1, :success => false}),
          :stderr => "",
          :exit_status => 0
        },
      ...
      },
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate(EXECUTABLE_FAILED_RESPONSE),
          :stderr => "",
          :exit_status => 0
        },
    ...
    examples = [
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_ID_TOKEN),
          :stderr => "",
          :exit_status => 0
        },
        :expect_token => EXECUTABLE_OIDC_TOKEN
      },
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_JWT),
          :stderr => "",
          :exit_status => 0
        },
        :expect_token => EXECUTABLE_OIDC_TOKEN
      },
      {
        ...
        :executable_return => {
          :stdout => MultiJSON.generate(EXECUTABLE_SUCCESSFUL_SAML_RESPONSE),
          :stderr => "",
          :exit_status => 0
        },
        :expect_token => EXECUTABLE_SAML_TOKEN
